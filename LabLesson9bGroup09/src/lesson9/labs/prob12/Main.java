...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(LambdaLibrary.FILTER_EMPLOYEE_SALARY.apply(list, 100000, 'E'));
		...
		System.out.println(LambdaLibrary.FILTER_EMPLOYEE_UPPER_CASE.apply(list, 85000, 'R'));
